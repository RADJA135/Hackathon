<script setup lang="ts">
    ...
    const color = colors[props.decision as keyof typeof colors] || '#8AA0BE';
    const r = 70;
    const c = r * Math.PI * 2;
...
<template>
    <svg width="180" height="180" viewBox="0 0 180 180">
        ...
        <circle cx="90" cy="90" :r="r" fill="none" :stroke="color" stroke-width="10" :stroke-dasharray="c" :stroke-dashoffset="offset"
